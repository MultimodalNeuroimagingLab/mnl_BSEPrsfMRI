function [ni, els, els_ind] = ssf_position2resliced_rs_image( ...
    els, fname, circleradius)
% ssf_position2resliced_rs_image
%
% Create a spherical electrode ROI in the voxel space of a reference
% NIfTI image.
%
% INPUTS
%   els          - N x 3 electrode coordinates in native/world space
%   fname        - Reference NIfTI image
%   circleradius - ROI radius in mm
%
% OUTPUTS
%   ni      - NIfTI structure containing electrode ROI(s)
%   els     - Input electrode coordinates
%   els_ind - Electrode coordinates converted to voxel indices
%
% Adapted for the mnl_BSEPrsfMRI pipeline by:
...
%
% Original code:
% Copyright (C) 2009 D. Hermes
% Dept of Neurology and Neurosurgery,
% University Medical Center Utrecht
%
% Original version 1.1.0, released 26-11-2009.
%
